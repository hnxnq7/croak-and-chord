const state = { flavor: 'sunny', tempo: 108, energy: 2, swing: 1, songName: 'Little Day Out', notes: [], vocalEnabled: true, vocalText: '', playing: false, context: null, timers: [], covers: {}, activeCard: null, rightsOK: false };
...
function setup() {
  ...
  document.querySelector('#rights-ack').addEventListener('change', event => { state.rightsOK = event.target.checked; });
